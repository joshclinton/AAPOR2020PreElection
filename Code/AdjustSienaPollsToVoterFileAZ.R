##############################################################################
##  Analyze Siena/NYT Arizona Data
...
dat <- read_sav("Google Drive/AAPOR.PreElectionPolling/Other Data/2020 General State Level Polls/Siena_Final Datasets/datasetAZ.sav")
...
Siena_AZ <- merge(dat,az_ctyinfo,by="county_name")
...
Siena_AZ$EDVote <- 0
Siena_AZ$EDVote[Siena_AZ$QMETH2==1] <- 1
Siena_AZ$EarlyVote <- 0
Siena_AZ$EarlyVote[Siena_AZ$QEVMETH==1] <- 1
Siena_AZ$EarlyVote[Siena_AZ$QMETH2==2] <- 1
Siena_AZ$AbsenteeVote <- 0
Siena_AZ$AbsenteeVote[Siena_AZ$QMETH2==3] <- 1
Siena_AZ$AbsenteeVote[Siena_AZ$QEVMETH==2] <- 1

for(i in 1:3){
  datsub <- subset(Siena_AZ,party_stratum==i)
...
for(i in 1:5){
  Siena_AZ$ModeWgt[Siena_AZ$party_stratum==i & Siena_AZ$EDVote==1] <- EDWgt[i]
  Siena_AZ$ModeWgt[Siena_AZ$party_stratum==i & Siena_AZ$EarlyVote==1] <- EarlyWgt[i]
  Siena_AZ$ModeWgt[Siena_AZ$party_stratum==i & Siena_AZ$Absentee==1] <- AbsWgt[i]
}
# How correlated are these?  
cor(Siena_AZ$final_weight,Siena_AZ$ModeWgt,use="pairwise.complete")
...
Siena_AZ$WeightModeWgt <- Siena_AZ$ModeWgt*Siena_AZ$final_weight
...
for(i in 1:3){
  Siena_AZ$VoteWgt[Siena_AZ$party_stratum==i & Siena_AZ$QPRES==1] <- BidenWgt[i]
  Siena_AZ$VoteWgt[Siena_AZ$party_stratum==i & Siena_AZ$QPRES==2] <- TrumpWgt[i]
}

# How correlated are these?  
cor(Siena_AZ$final_weight,Siena_AZ$VoteWgt,use="pairwise.complete")

Siena_AZ$WeightVoteModeWgt <- Siena_AZ$VoteWgt*Siena_AZ$WeightModeWgt
...
TrumpStrata.AZ <- Poll3.Trump.Vote.Strata - Poll.Trump.Vote.Strata
BidenStrata.AZ <- Poll3.Biden.Vote.Strata - Poll.Biden.Vote.Strata
...
Siena_AZ$QRACE[Siena_AZ$QRACE==4] <- 5
Siena_AZ$QRACE[Siena_AZ$QRACE==6] <- 5
Siena_AZ$QRACE[Siena_AZ$QRACE==9] <- NA
Siena_AZ$GENDER[Siena_AZ$GENDER==3] <- NA

Siena_AZ$QVOTE16[Siena_AZ$QVOTE16==5] <- 8
Siena_AZ$QVOTE16[Siena_AZ$QVOTE16==7] <- 6

png(file="Google Drive/AAPOR.PreElectionPolling/Writing/Figures/AZAdjust_Siena.png",width=600, height=900)
...
datsub <- na.omit(as.data.frame(cbind(Siena_AZ$QRACE,Siena_AZ$final_weight,Siena_AZ$WeightVoteModeWgt)))
...
# Education
datsub <- na.omit(as.data.frame(cbind(Siena_AZ$QEDUC4,Siena_AZ$final_weight,Siena_AZ$WeightVoteModeWgt)))
...
tb <- tb*100
labt <- get_labels(Siena_AZ$QEDUC4)
...
# Gender
datsub <- na.omit(as.data.frame(cbind(Siena_AZ$GENDER,Siena_AZ$final_weight,Siena_AZ$WeightVoteModeWgt)))
...
# Age
datsub <- na.omit(as.data.frame(cbind(Siena_AZ$AGE4,Siena_AZ$final_weight,Siena_AZ$WeightVoteModeWgt)))
...
tb <- tb*100
labt <- get_labels(Siena_AZ$AGE4)[1:4]
...
datsub <- na.omit(as.data.frame(cbind(Siena_AZ$QVOTE16,Siena_AZ$final_weight,Siena_AZ$WeightVoteModeWgt)))
...
# PARTY
datsub <- na.omit(as.data.frame(cbind(Siena_AZ$QPARTYID,Siena_AZ$final_weight,Siena_AZ$WeightVoteModeWgt)))
...
tb <- tb*100
labt <- get_labels(Siena_AZ$QPARTYID)
...
ChangeAZ <- table(Vote2106=Siena_AZ$QVOTE16,Vote2020=Siena_AZ$QPRES)

# New Voters
sum(as.logical(Siena_AZ$QVOTE16==8)*Siena_AZ$final_weight)/sum(Siena_AZ$final_weight)
sum(as.logical(Siena_AZ$QVOTE16==8 & Siena_AZ$QPRES==1)*Siena_AZ$final_weight)/sum(as.logical(Siena_AZ$QVOTE16==8)*Siena_AZ$final_weight)
sum(as.logical(Siena_AZ$QVOTE16==8 & Siena_AZ$QPRES==2)*Siena_AZ$final_weight)/sum(as.logical(Siena_AZ$QVOTE16==8)*Siena_AZ$final_weight)
sum(as.logical(Siena_AZ$QVOTE16==8 & Siena_AZ$QPRES==9)*Siena_AZ$final_weight)/sum(as.logical(Siena_AZ$QVOTE16==8)*Siena_AZ$final_weight)
